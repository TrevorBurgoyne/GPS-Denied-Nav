...
if (SAVE_FLAG)
    ...
    var_list_1 = ['t dt p_N_GNSS p_E_GNSS v_N_GNSS v_E_GNSS psi_compass'];
    var_list_2 = ['xddot yddot psidot p_N p_E v_N v_E psi_true'];
    var_list_3 = ['f_x f_y omega_z b_ax b_ay b_g w_a w_g'];
    var_list_4 = ['b_asx b_asy b_adx b_ady tau_a b_gs b_gd tau_g'];
    var_list_5 = ['compass_noise GNSS_vel_noise GNSS_pos_noise'];
    var_list_6 = ['sigma_adx sigma_ady sigma_gd sigma_wa sigma_wg'];
    var_list_all = [var_list_1,' ',var_list_2,' ',var_list_3,' ',...
                var_list_4,' ',var_list_5,' ',var_list_6];
    
    eval(['save -binary ',path_n_file,' ',var_list_all]);
