...
function [pos, orient, vel, acc, angvel, times, wps, t] = trajectory2(Fs)
    ...
    % Waypoints (m)
    wps2 = [x0+4e3,  0-1e3,  z0+7e3;  % 1
            x0+5e3,  0+2e3,  z0+9e3;  % 2
            x0+8e3,  0+4e3,  z0+4e3;  % 3
            x0+14e3, 0-1e3,  z0+9e3;  % 4
            x0+18e3, 0-5e3,  z0+7e3;  % 5
            x0+25e3, 0-7e3,  z0+10e3; % 6
            x0+33e3, 0-9e3,  z0+14e3; % 7
            x0+38e3, 0-11e3, z0+14e3; % 8
            x0+45e3, 0-7e3,  z0+7e3;  % 9
            x0+46e3, 0-6e3,  z0+20e3; % 10
            x0+55e3, 0-4e3,  z0+23e3; % 11
            x0+59e3, 0-1e3,  z0+18e3; % 12
            x0+69e3, 0+5e3,  z0+18e3; % 13
            x0+61e3, 0+10e3, z0+18e3; % 14
            x0+69e3, 0+11e3, z0+25e3; % 15
            x0+74e3, 0+15e3, z0+28e3; % 16
            x0+80e3, 0+14e3, z0+27e3; % 17
            x0+83e3, 0+16e3, z0+28e3; % 18
            x0+88e3, 0+16e3, z0+30e3; % 19
            x0+91e3, 0+18e3, z0+33e3;  % 20
